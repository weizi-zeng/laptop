...
<body>
<div id="header-div">
  <div id="logo-div" style="bgcolor:#000000;"><font size="6" style="font-family: 华文行楷"><?php echo $this->_var['restaurant']; ?>后台管理</font> 管理员， 欢迎登陆管理中心</div>
  ...
  <div id="submenu-div">
    <div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
      ...
      <a href="privilege.php?act=logout" target="_top" class="fix-submenu">退出登陆</a>
    </div>
...
<div id="menu-div">
  <ul>
    ...
    <li><a href="dishes.php?act=list" target="main-frame">商品列表</a></li>
