...
$_LANG['cp_home'] = '管理中心';
$_LANG['copyright'] = '版权所有 &copy; ZWT技有限公司，并保留所有权利。';
...
/* 菜单分类部分 */
$_LANG['02_cat_and_goods'] = '菜品管理';
$_LANG['03_restaurant'] = '餐厅管理';
...
$_LANG['02_goods_add'] = '添加新菜品';
$_LANG['03_category_list'] = '菜品分类';
$_LANG['04_category_add'] = '添加分类';
$_LANG['05_batch_add'] = '批量导入菜品';

/*餐厅管理*/
$_LANG['01_rest_list'] = '餐厅列表';
$_LANG['02_rest_add'] = '添加新餐厅';


$_LANG['05_comment_manage'] = '用户评论';
$_LANG['06_goods_brand_list'] = '菜品品牌';
$_LANG['07_brand_add'] = '添加品牌';
$_LANG['08_goods_type'] = '菜品类型';
$_LANG['09_attribute_list'] = '菜品属性';
$_LANG['10_attribute_add'] = '添加属性';
$_LANG['11_goods_trash'] = '菜品回收站';
$_LANG['12_batch_pic'] = '图片批量处理';
$_LANG['13_batch_add'] = '菜品批量上传';
$_LANG['15_batch_edit'] = '菜品批量修改';
$_LANG['16_goods_script'] = '生成菜品代码';
$_LANG['17_tag_manage'] = '标签管理';
$_LANG['18_product_list'] = '货品列表';
$_LANG['52_attribute_add'] = '编辑属性';
$_LANG['53_suppliers_goods'] = '供货商菜品管理';

$_LANG['14_goods_export'] = '菜品批量导出';

$_LANG['50_virtual_card_list'] = '虚拟菜品列表';
$_LANG['51_virtual_card_add'] = '添加虚拟菜品';
...
/* 积分兑换管理 */
$_LANG['15_exchange_goods'] = '积分商城菜品';
$_LANG['15_exchange_goods_list'] = '积分商城菜品列表';
$_LANG['exchange_goods_add'] = '添加新菜品';
